...
void kernel1(float *partD, float *partUx, float *partUy, float *Ux, float *Uy) {
  ...
  __m256 reg6 = _mm256_load_ps(partD + (2 * SIMD_SIZE));
  __m256 reg7 = _mm256_load_ps(partUx + (2 * SIMD_SIZE));
  __m256 reg8 = _mm256_load_ps(partUy + (2 * SIMD_SIZE));
  __m256 reg9 = _mm256_load_ps(partD + (3 * SIMD_SIZE));
  __m256 reg10 = _mm256_load_ps(partUx + (3 * SIMD_SIZE));
  __m256 reg11 = _mm256_load_ps(partUy + (3 * SIMD_SIZE));
  ...
  reg6 = _mm256_mul_ps(reg6, reg15);
  reg9 = _mm256_mul_ps(reg9, reg15);

  reg1 = _mm256_div_ps(reg1, reg0); // Ux
  reg2 = _mm256_div_ps(reg2, reg0); // Uy
  reg4 = _mm256_div_ps(reg4, reg3);
  reg5 = _mm256_div_ps(reg5, reg3);
  reg7 = _mm256_div_ps(reg7, reg6);
  reg8 = _mm256_div_ps(reg8, reg6);
  reg10 = _mm256_div_ps(reg10, reg9);
  reg11 = _mm256_div_ps(reg11, reg9);

  _mm256_store_ps(Ux, reg1);
  _mm256_store_ps(Uy, reg2);
  _mm256_store_ps(Ux + SIMD_SIZE, reg4);
  _mm256_store_ps(Uy + SIMD_SIZE, reg5);
  _mm256_store_ps(Ux + (2 * SIMD_SIZE), reg7);
  _mm256_store_ps(Uy + (2 * SIMD_SIZE), reg8);
  _mm256_store_ps(Ux + (3 * SIMD_SIZE), reg10);
  _mm256_store_ps(Uy + (3 * SIMD_SIZE), reg11);
}
